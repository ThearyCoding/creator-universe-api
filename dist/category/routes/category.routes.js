 ...
 *         description: Duplicate name or slug
 */
router.patch("/:idOrSlug", auth_1.authenticate, (0, authorizeRoles_1.authorizeRoles)("admin"), (0, asyncHandler_1.asyncHandler)(async (req, res) => {
 ...
 *         description: Not found
 */
router.delete("/:idOrSlug", auth_1.authenticate, (0, authorizeRoles_1.authorizeRoles)("admin"), (0, asyncHandler_1.asyncHandler)(async (req, res) => {
