 ...
 *         description: Duplicate code
 */
router.patch("/:idOrCode", (0, asyncHandler_1.asyncHandler)(async (req, res) => {
 ...
 *         description: Not found
 */
router.delete("/:idOrCode", (0, asyncHandler_1.asyncHandler)(async (req, res) => {
 ...
 */
router.patch("/:idOrCode/values/:valueId", (0, asyncHandler_1.asyncHandler)(async (req, res) => {
 ...
 *         description: Attribute or value not found
 */
router.delete("/:idOrCode/values/:valueId", (0, asyncHandler_1.asyncHandler)(async (req, res) => {
